...
public class KeywordCheckAction {
	...
	protected static final String MARKER_ID = "photrankeywordmarker";
	protected static final String VIOLATION = "violation";
	protected static final String KEYWORD   = "keyword";
	protected static final int KEYWORD_VIOLATION = 1;
	 ...
	 * @param file IFIle object of hte current file
	 */
	...
	public void generateMarker(Token token) {
		...
		String fullMarkerId = Activator.PLUGIN_ID + "." + MARKER_ID;
		try {
			IMarker marker = resource.createMarker(fullMarkerId);
			if (marker.exists()) {
				...
				marker.setAttribute(VIOLATION, KEYWORD_VIOLATION);
